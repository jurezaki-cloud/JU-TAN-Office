...
class ReportsPage(QWidget):
    ...
    def _build_dashboard(self) -> QWidget:
        ...
        grid.setSpacing(16)
        self.kpi_outstanding = KpiCard("Odprti računi", "0", "Neplačani")
        self.kpi_low = KpiCard("Nizka zaloga", "0", "Pod pragom")
