...
a = Analysis(
    ...
    datas=[
        ...
        # Production PUBLIC verification keys only (never private signing keys).
        (str(ROOT / "resources" / "update_keys" / "production"), "resources/update_keys/production"),
    ],
    hiddenimports=[
        "PySide6.QtCore",
        "PySide6.QtGui",
        ...
        "app.core.update",
        "app.core.update_manifest",
        "app.core.update_signing",
        "app.core.update_policy",
        "app.core.update_trust",
        "app.core.versioning",
